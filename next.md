...
8. **SelectControl layout**: `flex-column` — label зверху, контрол знизу; текст не обрізається.
...
13. **README.md.jsx**: Оновлено документацію — додано Header, OlmuiInspector, StylesClass (Model as Schema), Export.
