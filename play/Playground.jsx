...
function BlockShowcase({
	...
	return (
		<div id={id} className="container mt-5 mb-5 pb-5 border-bottom">
	...
	return (
		...
		>
			...
			<div className="col-md-9 col-lg-10">
				{/* Top Header */}
				<div className="bg-white shadow-sm border-bottom py-3 px-4 mb-4 d-flex justify-content-between align-items-center">
					<div>
					...
					<div>
						<button className="btn btn-outline-primary fw-bold" onClick={toggleLocale}>
				...
				<div className="container-fluid px-4 pb-5">
					...
					<BlockShowcase
						id="block-files"
						title="Blocks.Files"
						description="Секція документів (іконку скріпки додає сам компонент за замовчуванням)."
						locale={locale}
					...
					<BlockShowcase
						id="block-price"
						title="Blocks.Price"
						description="Блок для відображення ціни. Підтримує локалізацію (UK/EN 'Ціна' vs 'Price')."
						locale={locale}
					...
					>
						<Blocks.Price page={{ price: 'Безкоштовно ($0)' }} locale={locale} />
					</BlockShowcase>
